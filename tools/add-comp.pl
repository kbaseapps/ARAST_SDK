...
sub install_idba {
    my $dir = 'idba-1.1.2';
    my $file = "$dir.tar.gz";
    download($dir, $file, 'https://github.com/loneknightpy/idba/releases/download/1.1.2');
...
sub install_prodigal {
    ...
    my $file = "v2.60.tar.gz";
    download($dir, $file, "https://github.com/hyattpd/Prodigal/archive/");
    run("cd $dir; make -j");
